...
Function         | Remarks
-----------------| ----------------------------------------------
`importdmd()`  | Import dm+d files and link it to the BNF code using June 2018 snomed mapping file
...
The `importdmd()` function supports import of dm+d files and generate a data object linking each API to its BNF Code, strength and medicinal form. For an overview of these functionalities see the documentation. Some examples:
